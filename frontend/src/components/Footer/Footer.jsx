                  ...
                  if (l.label === 'Services') {
                    return (
                      <li key={l.href} className="footer__link-item--services">
                        ...
                        <div className={`footer__services-submenu ${servicesExpanded ? 'footer__services-submenu--open' : ''}`}>
            ...
            <div className="footer__col">
              ...
              <address className="footer__address">
                <div className="footer__contact-item">
                  ...
                  >
                    Industrial Area, Phase II<br/>Bangalore, Karnataka 560 058
                  </a>
                </div>
                <div className="footer__contact-item">
                  ...
                  <a href="tel:+919916353979" className="footer__link">+91 99163 53979</a>
                </div>
                <div className="footer__contact-item">
